...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (onlineSensorIds.length > 0 && !onlineSensorIds.includes(selectedSensor)) {
      setSelectedSensor(onlineSensorIds[0]);
    }
  }, [shipments, selectedSensor]);
    ...
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <div className={styles.metrics}>
          {[
            { label: 'Active Shipments', value: activeShipments.length, sub: `${activeShipments.length} in transit`, color: 'var(--text-primary)' },
            { label: 'Sensors Online', value: onlineSensorIds.length, sub: `${shipments.length - activeShipments.length} idle`, color: 'var(--accent-green)' },
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              >
                {onlineSensorIds.length > 0 ? (
                  onlineSensorIds.map(sid => (
